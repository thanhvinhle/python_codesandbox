#
# Source code from https://neetcode.io/courses/lessons/python-for-coding-interviews with some minor modifications
#
...
# Increment
n = n + 1 # good
n += 1    # good, but "n++" is invalid syntax
...
### => If statements don't need parentheses or curly braces, but parentheses needed for multi-line conditions.
# and = &&
# or  = ||
n = 1
if ((n > 2 and 
